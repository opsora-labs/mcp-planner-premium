...
const SERVER_INSTRUCTIONS = [
  ...
  "",
  "Typical flow: find_plan_by_name -> create_plan / add_bucket -> start_change_session -> add_tasks / update_tasks / delete_tasks_batch -> apply_changes -> poll check_change_session_status until statusCode 192350003 (Completed) -> get_plan_tasks_and_buckets to verify. Prefer the ergonomic add_tasks / update_tasks (plain lists, server builds the OData payload) over the raw add_tasks_batch / update_tasks_batch.",
  "",

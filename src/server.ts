...
const SERVER_INSTRUCTIONS = [
  ...
  "8. delete_tasks_batch requires confirmed=true only after explicit per-record user confirmation. Whole-plan deletion is blocked - point the user to the Planner UI. (assign_task mode='unassign' and update_tasks checklist removals (remove:true) likewise require confirmed=true.)",
